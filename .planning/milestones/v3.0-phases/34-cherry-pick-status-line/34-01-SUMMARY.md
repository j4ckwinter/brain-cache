...
- FOUND: src/scripts/statusline.mjs
- FOUND: src/lib/statusline-script.ts
- FOUND: tests/services/sessionStats.test.ts
- FOUND: tests/scripts/statusline.test.ts
- FOUND: tests/scripts/statusline.integration.test.ts
- FOUND: .planning/phases/34-cherry-pick-status-line/34-01-SUMMARY.md
- FOUND commit: 50022a0
- FOUND commit: 8be3bd2
